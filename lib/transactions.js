...
if (transaction.version != 5) {
  ...
  transformed.nType = transaction.nType;
  transformed.collateralOutput = transaction.collateralOutput;
  transformed.collateralOutputHash = transaction.collateralOutputHash;
  transformed.collateralOutputIndex = transaction.collateralOutputIndex;
  transformed.sigTime = transaction.sigTime;
  transformed.sig = transaction.sig;
  if (transaction.nTtype == ZELNODE_START_TX_TYPE) {
    transformed.collateralPubKey = transaction.collateralPubKey;
    transformed.zelnodePubKey = transaction.zelnodePubKey;
    transformed.ip = transaction.ip;
  }
  if (transaction.nTtype == ZELNODE_CONFIRM_TX_TYPE) {
    transformed.updateType = transaction.updateType;
    transformed.benchmarkTier = transaction.benchmarkTier;
    transformed.benchmarkSigTime = transaction.benchmarkSigTime;
    transformed.benchmarkSig = transaction.benchmarkSig;
  }
}
...
TxController.prototype.transformZelcashTransaction = function (transaction) {
