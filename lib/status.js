...
StatusController.prototype.getZelNodes = function (callback) {
  this.node.services.bitcoind.viewdeterministiczelnodelist(function (err, response) {
    ...
    var zelnodes = response.result;
    callback(null, zelnodes);
  });
};
...
StatusController.prototype.circulation = function (req, res) {
  ...
  var coins = ((657350 - 5000) * 150) + 312500 + 13020000;
  coins += (self.node.services.bitcoind.height - 657350) * subsidy;
  // TODO fix for halvings
  res.jsonp({
